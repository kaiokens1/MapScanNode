...
using MapScan.Networks.Policies;
using MapScan.Networks.Rules;
...
using MapScan.Networks.Deployments;
using Blockcore.NBitcoin.BouncyCastle.math;
using Blockcore.NBitcoin.DataEncoders;

namespace MapScan.Networks
{
    public class MapScanMain : Network
   {
      public MapScanMain()
      {
         CoinSetup setup = MapScanSetup.Instance.Setup;
         NetworkSetup network = MapScanSetup.Instance.Main;

         NetworkType = NetworkType.Mainnet;
         DefaultConfigFilename = setup.ConfigFileName; // The default name used for the MapScan configuration file.
         ...
         var bip9Deployments = new MapScanBIP9Deployments()
         {
            [MapScanBIP9Deployments.ColdStaking] = new BIP9DeploymentsParameters("ColdStaking", 2,
         ...
         Consensus.PosEmptyCoinbase = MapScanSetup.Instance.IsPoSv3();
         Consensus.PosUseTimeFieldInKernalHash = MapScanSetup.Instance.IsPoSv3();
         ...
         StandardScriptsRegistry = new MapScanStandardScriptsRegistry();
      ...
      protected void RegisterRules(IConsensus consensus)
      {
         consensus.ConsensusRules
             ...
             .Register<MapScanHeaderVersionRule>()
