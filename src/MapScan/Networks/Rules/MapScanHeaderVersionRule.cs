...
namespace MapScan.Networks.Rules
{
   /// <summary>
   /// Checks if <see cref="MapScanMain"/> network block's header has a valid block version.
   /// </summary>
   public class MapScanHeaderVersionRule : HeaderVersionRule
   {
      /// <inheritdoc />
